        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              <strong className="text-foreground">The Agent as a Service Company</strong>
            </p>
          ...
          {/* Navigation Column */}
          <div>
            <h3 className="font-outfit font-bold text-lg mb-4">Platform</h3>
          ...
          {/* Social Column */}
          <div>
            <h3 className="font-outfit font-bold text-lg mb-4">Connect</h3>
            <nav className="flex flex-col gap-3">
              <a 
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-lg border border-border hover:border-primary hover:bg-primary/5 flex items-center justify-center transition-all duration-300"
              aria-label="LinkedIn"
            >
