          ...
          <div className="relative p-12 md:p-16 rounded-3xl border border-primary/30 bg-gradient-to-br from-card/80 via-card/60 to-card/80 backdrop-blur-xl overflow-hidden">
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
                The best way to understand krinAI?{" "}
                <strong className="text-foreground">See it in action.</strong>
              </p>
              ...
              <p className="text-sm text-muted-foreground">
                Join 2,000+ companies already running krinAI agents. Your first agent deploys in the time it took you to read this page.
              </p>
            </div>
